...
proc generateDecode*(file: File, constructors: seq[TLConstructor]) =
    ...
    for constructor in constructors:
        let constructorName = generateStylizedName(constructor.name, constructor.namespaces)
        ...
        for parameter in constructor.parameters:
            ...
            if parameter.parameterType.get() of TLParameterTypeSpecified:
                ...
                if (typeConverted.type.bare or typeConverted.type.name.toLower == "bool") and typeConverted.type.name.toLower != "future_salt":
                ...
                if typeConverted.type.genericArgument.isSome() and codeType != "":
                    if typeConverted.type.genericArgument.get().name.toLower() == "vector":
                        if (typeConverted.type.bare or
                                typeConverted.type.name.toLower == "bool" or typeConverted.type.genericReference) and typeConverted.type.name.toLower != "future_salt":
                    ...
                    if (typeConverted.type.bare or typeConverted.type.genericReference or typeConverted.type.name.toLower == "bool") and typeConverted.type.name.toLower != "future_salt":
